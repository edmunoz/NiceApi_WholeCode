...
//{
//    class Data_Net__04CheckTelNumbers_SQLite: IData_Net__04CheckTelNumbers_store, IsqLiteTable
//    {
//        #region table
//        public static readonly string fUserId = "UserId";
//        public static readonly string fMsgTicks = "MsgTicks";
//        public static readonly string fTelList = "TelList";
//        public static readonly string fTelListChecked = "TelListChecked";
...
//        public string TableName { get { return "CheckTelNumbers"; } }
...
//            {
//                Data_Net__04CheckTelNumbers x = (Data_Net__04CheckTelNumbers)srcTarget;
...
//                    new sqLiteTableField(fUserId, "TEXT", "UserId"),
//                    new sqLiteTableField(fMsgTicks, "TEXT", "MsgTicks", null, custom_Trans_Value),
//                    new sqLiteTableField(fTelList, "TEXT", "TelList"),
//                    new sqLiteTableField(fTelListChecked, "TEXT", "TelListChecked"),
...
//        {
//            return new Data_Net__04CheckTelNumbers();
//        }
//        #endregion

//        public Data_Net__04CheckTelNumbers_SQLite(IMyLog log)
//        {
...
//        public void Store(Data_Net__04CheckTelNumbers msg, IMyLog log)
//        {
//            try
//            {
...
//        public void ForEach(IMyLog log, dProcess_Data_Net__04CheckTelNumbers cb)
//        {
//            try
//            {
...
//                    {
//                        Data_Net__04CheckTelNumbers bd = (Data_Net__04CheckTelNumbers)built;
//                        cb(bd);
//                    });
//            }
//            catch (SystemException se)
...
//        public Data_Net__04CheckTelNumbers ReadOne(string fileName, IMyLog log)
//        {
//            Data_Net__04CheckTelNumbers ret = null;
//            try
//            {
